...
FlatListItemSeparator = () => {
  ...
  render() {
    ...
    if (this.state.isLoading) {
      return (
        <View style={{flex: 1, paddingTop: 20,backgroundColor:'dimgrey'}}>
          <Text style={{flex: 1, paddingTop: 20,justifyContent:'center'}}>History Is loading  </Text>
    ...
    return (
        ...
        <Text style={{fontSize:20,fontWeight:'bold',textAlign:'center'}}> History </Text>
          ...
          <Text style={styles.buttonText} title="Submit" onPress={this.OpenActivity3}>Accept Reservation</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button1}>
          <Text style={styles.buttonText} title="Submit" onPress={this.OpenActivity3}>Reject Reservation</Text>
        </TouchableOpacity>
